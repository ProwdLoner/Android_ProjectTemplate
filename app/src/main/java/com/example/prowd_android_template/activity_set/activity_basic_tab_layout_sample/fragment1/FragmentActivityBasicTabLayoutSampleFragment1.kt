...
class FragmentActivityBasicTabLayoutSampleFragment1 : Fragment() {
    ...
    // (어뎁터 객체)
    lateinit var adapterSetMbr: FragmentActivityBasicTabLayoutSampleFragment1AdapterSet
    ...
    private fun onCreateViewInitObject() {
        ...
        adapterSetMbr = FragmentActivityBasicTabLayoutSampleFragment1AdapterSet()
    }
