...
class ActivityHome : AppCompatActivity() {
    ...
    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityHomeSpw
    ...
    private fun onCreateInitObject() {
        ...
        // SPW 객체 생성
        classSpwMbr = ActivityHomeSpw(application)
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityHomeSpw(application: Application) {
        // <멤버 변수 공간>
