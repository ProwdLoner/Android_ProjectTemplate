...
class ActivityBitmapAndOpencvJniSample : AppCompatActivity() {
    ...
    private fun onCreateInitView() {
        ...
        bindingMbr.redSrcImg.setOnClickListener {
            ...
            viewModelMbr.grayBitmapLiveDataMbr.value = copyBitmap1
            ...
            viewModelMbr.copyBitmapLiveDataMbr.value = copyBitmap2
        }
    ...
    private fun onCreateSetLiveData() {
        ...
        viewModelMbr.copyBitmapLiveDataMbr.observe(this) {
            Glide.with(this)
                .load(it)
                .into(bindingMbr.copyImg)
        }

        viewModelMbr.grayBitmapLiveDataMbr.observe(this) {
            Glide.with(this)
                .load(it)
    ...
    class ViewModel(application: Application) : AndroidViewModel(application) {
        ...
        val copyBitmapLiveDataMbr: MutableLiveData<Bitmap?> =
            MutableLiveData(null)

        val grayBitmapLiveDataMbr: MutableLiveData<Bitmap?> =
            MutableLiveData(null)
