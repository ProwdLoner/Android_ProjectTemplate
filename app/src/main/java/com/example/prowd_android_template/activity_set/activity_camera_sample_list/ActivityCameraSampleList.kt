...
import com.example.prowd_android_template.activity_set.activity_system_camera_video_sample.ActivitySystemCameraVideoSample
...
class ActivityCameraSampleList : AppCompatActivity() {
    ...
    // (어뎁터 객체)
    lateinit var adapterSetMbr: ActivityCameraSampleListAdapterSet

    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityCameraSampleListSpw
    ...
    private fun onCreateInitObject() {
        ...
        adapterSetMbr = ActivityCameraSampleListAdapterSet()

        // SPW 객체 생성
        classSpwMbr = ActivityCameraSampleListSpw(application)
    ...
    private fun onCreateInitView() {
        ...
        // 시스템 카메라 샘플 이동 버튼
        bindingMbr.goToSystemCameraVideoSampleBtn.setOnClickListener {
            // 액티비티 이동
            val intent =
                Intent(
                    this,
                    ActivitySystemCameraVideoSample::class.java
                )
            startActivity(intent)
        }
    }
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityCameraSampleListSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityCameraSampleListSpw",
...
//            }
    ...
    class ActivityCameraSampleListAdapterSet {
        // 어뎁터 #1
