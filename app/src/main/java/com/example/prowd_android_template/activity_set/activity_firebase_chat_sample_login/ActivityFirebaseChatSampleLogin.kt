package com.example.prowd_android_template.activity_set.activity_firebase_chat_sample_login
...
import com.example.prowd_android_template.databinding.ActivityFirebaseChatSampleLoginBinding
import com.example.prowd_android_template.databinding.ItemActivityFirebaseChatSampleLoginAdapterRecyclerViewItem1Binding
import com.example.prowd_android_template.databinding.ItemActivityFirebaseChatSampleLoginAdapterRecyclerViewItemLoaderBinding
...
class ActivityFirebaseChatSampleLogin : AppCompatActivity() {
    ...
    // <멤버 변수 공간>
    // (뷰 바인더 객체)
    lateinit var bindingMbr: ActivityFirebaseChatSampleLoginBinding

    // (repository 모델)
    lateinit var repositorySetMbr: RepositorySet

    // (어뎁터 객체)
    lateinit var adapterSetMbr: ActivityFirebaseChatSampleLoginAdapterSet

    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityFirebaseChatSampleLoginSpw
...
//    lateinit var fdRoot: DatabaseReference
    ...
    private fun onCreateInitObject() {
        // 뷰 객체
        bindingMbr = ActivityFirebaseChatSampleLoginBinding.inflate(layoutInflater)
        // 뷰 객체 바인딩
        ...
        adapterSetMbr = ActivityFirebaseChatSampleLoginAdapterSet(
            ActivityFirebaseChatSampleLoginAdapterSet.RecyclerViewAdapter(
                this,
        ...
        // SPW 객체 생성
        classSpwMbr = ActivityFirebaseChatSampleLoginSpw(application)
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityFirebaseChatSampleLoginSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityFirebaseChatSampleLoginSpw",
...
//            }
    ...
    class ActivityFirebaseChatSampleLoginAdapterSet(
        val recyclerViewAdapter: RecyclerViewAdapter
    ) {
        // 어뎁터 #1
        class RecyclerViewAdapter(
            private val parentViewMbr: ActivityFirebaseChatSampleLogin,
                ...
                return when (viewType) {
                    ...
                    ItemLoader::class.hashCode() -> {
                        ItemLoader.ViewHolder(
                            LayoutInflater.from(parent.context)
                                .inflate(
                                    R.layout.item_activity_firebase_chat_sample_login_adapter_recycler_view_item_loader,
                                    parent,
                                    false
                                )
                        )
                    ...
                    Item1::class.hashCode() -> {
                        Item1.ViewHolder(
                            LayoutInflater.from(parent.context)
                                .inflate(
                                    R.layout.item_activity_firebase_chat_sample_login_adapter_recycler_view_item1,
                                    parent,
                                    false
                                )
                        )
...
//                    val copyEntity = currentDataListCloneMbr[position] as ItemLoader.ItemVO
            ...
            class ItemLoader {
                data class ViewHolder(
                    val view: View,
                    val binding: ItemActivityFirebaseChatSampleLoginAdapterRecyclerViewItemLoaderBinding =
                        ItemActivityFirebaseChatSampleLoginAdapterRecyclerViewItemLoaderBinding.bind(
                            view
                        )
                ) : RecyclerView.ViewHolder(view)
            ...
            class Item1 {
                data class ViewHolder(
                    val view: View,
                    val binding: ItemActivityFirebaseChatSampleLoginAdapterRecyclerViewItem1Binding =
                        ItemActivityFirebaseChatSampleLoginAdapterRecyclerViewItem1Binding.bind(
                            view
                        )
                ) : RecyclerView.ViewHolder(view)
