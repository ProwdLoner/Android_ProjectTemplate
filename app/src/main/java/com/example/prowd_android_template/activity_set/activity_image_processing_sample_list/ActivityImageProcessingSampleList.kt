package com.example.prowd_android_template.activity_set.activity_image_processing_sample_list
...
class ActivityImageProcessingSampleList : AppCompatActivity() {
    ...
    // <멤버 변수 공간>
    // (뷰 바인더 객체)
    lateinit var bindingMbr: ActivityImageProcessingSampleListBinding

    // (repository 모델)
    lateinit var repositorySetMbr: RepositorySet

    // (어뎁터 객체)
    lateinit var adapterSetMbr: ActivityImageProcessingSampleListAdapterSet

    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityImageProcessingSampleListSpw
    ...
    private fun onCreateInitObject() {
        // 뷰 객체
        bindingMbr = ActivityImageProcessingSampleListBinding.inflate(layoutInflater)
        // 뷰 객체 바인딩
        ...
        adapterSetMbr = ActivityImageProcessingSampleListAdapterSet()

        // SPW 객체 생성
        classSpwMbr = ActivityImageProcessingSampleListSpw(application)
    ...
    private fun onCreateInitView() {
        bindingMbr.goToEasyLutSampleBtn.setOnClickListener {
            val intent =
                Intent(
                    this,
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityImageProcessingSampleListSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityImageProcessingSampleListSpw",
...
//            }
    ...
    class ActivityImageProcessingSampleListAdapterSet {
        // 어뎁터 #1
