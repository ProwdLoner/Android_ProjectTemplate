...
class ActivityRecyclerViewSampleList : AppCompatActivity() {
    ...
    // (어뎁터 객체)
    lateinit var adapterSetMbr: ActivityRecyclerViewSampleListAdapterSet

    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityRecyclerViewSampleListSpw
    ...
    private fun onCreateInitObject() {
        ...
        adapterSetMbr = ActivityRecyclerViewSampleListAdapterSet()

        // SPW 객체 생성
        classSpwMbr = ActivityRecyclerViewSampleListSpw(application)
    ...
    private fun onCreateInitView() {
        ...
        bindingMbr.goToBasicHeaderFooterRecyclerViewSampleBtn.setOnClickListener {
            val intent =
                Intent(
                    this,
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityRecyclerViewSampleListSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityRecyclerViewSampleListSpw",
...
//            }
    ...
    class ActivityRecyclerViewSampleListAdapterSet {
        // 어뎁터 #1
