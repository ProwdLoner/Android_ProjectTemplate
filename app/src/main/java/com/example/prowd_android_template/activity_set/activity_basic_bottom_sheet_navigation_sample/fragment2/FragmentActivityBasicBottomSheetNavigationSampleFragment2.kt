...
class FragmentActivityBasicBottomSheetNavigationSampleFragment2 : Fragment() {
    ...
    // (어뎁터 객체)
    lateinit var adapterSetMbr: FragmentActivityBasicBottomSheetNavigationSampleFragment2AdapterSet

    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: FragmentActivityBasicBottomSheetNavigationSampleFragment2Spw
    ...
    private fun onCreateViewInitObject() {
        ...
        adapterSetMbr = FragmentActivityBasicBottomSheetNavigationSampleFragment2AdapterSet()

        // SPW 객체 생성
        classSpwMbr =
            FragmentActivityBasicBottomSheetNavigationSampleFragment2Spw(requireActivity().application)
    }
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class FragmentActivityBasicBottomSheetNavigationSampleFragment2Spw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "FragmentActivityBasicBottomSheetNavigationSampleFragment2Spw",
...
//            }
    ...
    class FragmentActivityBasicBottomSheetNavigationSampleFragment2AdapterSet {
        // 어뎁터 #1
