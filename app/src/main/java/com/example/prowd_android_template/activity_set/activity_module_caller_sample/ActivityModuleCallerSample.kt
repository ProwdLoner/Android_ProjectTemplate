...
class ActivityModuleCallerSample : AppCompatActivity() {
    ...
    // (어뎁터 객체)
    lateinit var adapterSetMbr: ActivityModuleCallerSampleAdapterSet

    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityModuleCallerSampleSpw
    ...
    private fun onCreateInitObject() {
        ...
        adapterSetMbr = ActivityModuleCallerSampleAdapterSet()

        // SPW 객체 생성
        classSpwMbr = ActivityModuleCallerSampleSpw(application)
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityModuleCallerSampleSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityModuleCallerSampleSpw",
...
//            }
    ...
    class ActivityModuleCallerSampleAdapterSet {
        // 어뎁터 #1
