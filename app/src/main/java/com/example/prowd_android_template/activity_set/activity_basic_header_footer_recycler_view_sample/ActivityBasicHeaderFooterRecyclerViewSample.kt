...
class ActivityBasicHeaderFooterRecyclerViewSample : AppCompatActivity() {
    ...
    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityBasicHeaderFooterRecyclerViewSampleSpw
    ...
    private fun onCreateInitObject() {
        ...
        // SPW 객체 생성
        classSpwMbr = ActivityBasicHeaderFooterRecyclerViewSampleSpw(application)
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityBasicHeaderFooterRecyclerViewSampleSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityBasicHeaderFooterRecyclerViewSampleSpw",
...
//                    val copyEntity = currentDataListCloneMbr[position] as ItemLoader.ItemVO
                    ...
                    is Item1.ViewHolder -> { // 아이템1 아이템 바인딩
                        ...
                        binding.root.setOnClickListener {
                            parentViewMbr.putActivityBasicHeaderFooterRecyclerViewSampleAdapterSetRecyclerViewAdapterData(
                        ...
                        binding.deleteBtn.setOnClickListener {
                            parentViewMbr.deleteActivityBasicHeaderFooterRecyclerViewSampleAdapterSetRecyclerViewAdapterData(
                                copyEntity.serverItemUid,
                                onComplete = {})
                        }
