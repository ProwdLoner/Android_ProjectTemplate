...
class FragmentActivityBasicBottomSheetNavigationSampleFragment3 : Fragment() {
    ...
    override fun onResume() {
        ...
        if (!parentActivityMbr.viewModelMbr.isChangingConfigurationsMbr && // 화면 회전이 아니면서,
            ...
            if (parentActivityMbr.viewModelMbr.fragment3Data.isDataFirstLoadingMbr || // 데이터 최초 로딩 시점일 때 혹은,
                ...
                parentActivityMbr.viewModelMbr.fragment3Data.currentUserSessionTokenMbr = sessionToken
    ...
    private fun createViewModelDataObjects() {
        if (!parentActivityMbr.viewModelMbr.isChangingConfigurationsMbr) { // 설정 변경(화면회전)이 아닐 때에 발동
            ...
            // 현 액티비티 진입 유저 저장
            parentActivityMbr.viewModelMbr.fragment3Data.currentUserSessionTokenMbr = parentActivityMbr.viewModelMbr.currentLoginSessionInfoSpwMbr.sessionToken
        }
    }
