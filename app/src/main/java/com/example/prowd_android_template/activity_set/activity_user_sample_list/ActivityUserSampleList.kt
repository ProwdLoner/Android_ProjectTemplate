...
class ActivityUserSampleList : AppCompatActivity() {
    ...
    // (SharedPreference 객체)
    // 클래스 비휘발성 저장객체
    lateinit var classSpwMbr: ActivityUserSampleListSpw
    ...
    private fun onCreateInitObject() {
        ...
        // SPW 객체 생성
        classSpwMbr = ActivityUserSampleListSpw(application)
    ...
    // <중첩 클래스 공간>
    // (클래스 비휘발 저장 객체)
    class ActivityUserSampleListSpw(application: Application) {
        // <멤버 변수 공간>
        // SharedPreference 접근 객체
        private val spMbr = application.getSharedPreferences(
            "ActivityUserSampleListSpw",
...
//            }
    ...
    class ActivityUserSampleListAdapterSet {
        // 어뎁터 #1
