...
class ActivityBroadcastReceiverSample : AppCompatActivity() {
    ...
    private fun onCreateInitView() {
        ...
        registerReceiver(object : BroadcastReceiver() {
            override fun onReceive(context: Context?, intent: Intent?) {
                viewModelMbr.broadcastMsgLiveDataMbr.value = intent?.getStringExtra("value")
            }
        }, filter)
    }
    ...
    private fun onCreateSetLiveData() {
        ...
        viewModelMbr.broadcastMsgLiveDataMbr.observe(this) {
            bindingMbr.broadcastValue.text = it
        }
    }
    ...
    class ViewModel(application: Application) : AndroidViewModel(application) {
        ...
        val broadcastMsgLiveDataMbr: MutableLiveData<String?> =
            MutableLiveData(null)
