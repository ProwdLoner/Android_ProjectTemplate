...
class ActivityBasicTabLayoutSample : AppCompatActivity() {
    ...
    class ViewModel(application: Application) : AndroidViewModel(application) {
        ...
        val fragment1Mbr = FragmentActivityBasicTabLayoutSampleFragment1()
        val fragment1DataMbr =
            FragmentActivityBasicTabLayoutSampleFragment1.FragmentViewModel(
                application,
                repositorySetMbr,
                executorServiceMbr
            )

        val fragment2Mbr = FragmentActivityBasicTabLayoutSampleFragment2()
        val fragment2DataMbr =
            FragmentActivityBasicTabLayoutSampleFragment2.FragmentViewModel(
                application,
                repositorySetMbr,
                executorServiceMbr
            )
